...
func TestAddGetDelete(t *testing.T) {
	...
	p, err := store.Get(id)
	require.NoError(t, err)
	require.Equal(t, Parcel{Client: parcel.Client, Status: parcel.Status, Address: parcel.Address, CreatedAt: parcel.CreatedAt},
		Parcel{Client: p.Client, Status: p.Status, Address: p.Address, CreatedAt: p.CreatedAt})
...
func TestSetAddress(t *testing.T) {
	...
	p, err := store.Get(id)
	require.NoError(t, err)
	require.NotEqual(t, parcel.Address, p.Address)
...
func TestSetStatus(t *testing.T) {
	...
	p, err := store.Get(id)
	require.NoError(t, err)
	require.NotEqual(t, parcel.Status, p.Status)
